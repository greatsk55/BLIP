...
import { ShieldCheck, LogOut, Users, FileText } from 'lucide-react';
      ...
      <header className="sticky top-0 z-50 h-14 flex items-center justify-between px-4 bg-void-black/80 backdrop-blur-md border-b border-ink/5 pt-[env(safe-area-inset-top)]">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1 text-ink/40 hover:text-ink/70 active:text-ink/70 min-w-[44px] min-h-[44px] justify-center transition-colors"
            title={t('terms.viewInChat')}
          >
